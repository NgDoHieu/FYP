...
def main() -> None:
    ...
    audio_root = project_root / "raw" / "gtzan" / "genres"
    ...
    callbacks = [
        ...
        tf.keras.callbacks.ModelCheckpoint(output_dir / "gtzan_audio_cnn.keras", monitor="val_accuracy", mode="max", save_best_only=True),
    ]
    ...
    results = {
        ...
        "model_file": str(output_dir / "gtzan_audio_cnn.keras"),
